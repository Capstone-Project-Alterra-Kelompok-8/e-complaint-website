        ...
        try {
            ...
            if (result.success) {
                ...
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Successfully updated the news",
                    showConfirmButton: false,
                    timer: 1500
                });
                navigate(`/news-detail/${id}`);
            } else {
                alert('Terjadi kesalahan saat mengupdate berita saat edit news');
            }
        } catch (error) {
            ...
            <div className="lg:ml-80 py-3 px-2 min-h-[80dvh] overflow-y-auto">
                <main>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Start This is Button in edit news */}
                        ...
                        {/* End This is Button in edit news */}
                    </form>
                    {/* End Content in edit news */}
                </main>
            </div>
        </section>
    );
