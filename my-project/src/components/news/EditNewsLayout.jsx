...
const EditNewsLayout = () => {
  ...
  useEffect(() => {
    ...
    const fetchNews = async () => {
      try {
        const response = await axios.get(`https://capstone-dev.mdrizki.my.id/api/v1/news/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://capstone-dev.mdrizki.my.id/api/v1/news/${id}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
              ...
              <div className="flex space-x-4">
                ...
                <div className="flex w-1/2 items-center justify-center">
                  ...
                  >
                    <div className="flex flex-col items-center justify-center pb-6 pt-5">
                      <img src={`https://storage.googleapis.com/e-complaint-assets/${existingFile}`} alt="News" className="h-32 w-32 object-cover" />
                      <svg width={27} height={27} viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          ...
                          fill="#6B7280"
                        />
                        <path d="M2.25 20.8747L8.93319 14.7485C9.39931 14.3212 10.1112 14.3093 10.5913 14.7209L18.5 21.4997" stroke="#6B7280" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M16 18.3749L18.9834 15.3915C19.4232 14.9517 20.1196 14.9022 20.6173 15.2754L24.75 18.3749" stroke="#6B7280" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M17.25 6.5H24.75" stroke="#6B7280" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M21 2.75V10.25" stroke="#6B7280" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
                      </svg>

                      <p className="mb-2 text-sm font-montserrat text-dark-3 dark:text-gray-400">Drop image here or select File</p>
                ...
                <div className="flex flex-col w-1/2 space-y-4">
                  <div className="flex flex-col">
                    ...
                    <input type="text" id="title" value={title} onChange={(e) => setTitle(e.target.value)} required className="p-2 border border-gray-300 rounded" />
                  </div>
                  <div className="flex flex-col">
                    <label htmlFor="kategory">Kategori Berita</label>
                    <select id="kategory" value={categoryId} onChange={(e) => setCategoryId(e.target.value)} required className="p-2 border border-gray-300 rounded">
